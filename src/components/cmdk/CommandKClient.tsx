    ...
    const clientSections: CommandKSection[] = [
        {
            ...
            items: [
                ...
                },
                {
                    label: "Light Mode",
                    annotation: (
                        <BiSun size={16} className="translate-x-[1.25px]" />
                    ),
        ...
        clientSections.push({
            ...
            items: [
                ...
                },
                {
                    ...
                    action: () =>
                        setShouldDebugImageFallbacks?.((prev) => !prev),
                                                    ...
                                                    onSelect={() => {
                                                        ...
                                                        if (path) {
                                                            if (
                                                                ...
                                                                startTransition(
                                                                    async () => {
                                                                        shouldCloseAfterPending.current =
                                                                            true;
                                                                        router.push(
                                                                            path,
                                                                            {
